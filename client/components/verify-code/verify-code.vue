<template>
  <view class="xt__verify-code">
    ...
    <view
      ...
      class="xt__cursor"
      :style="{
        left: codeCursorLeft[code.length] + 'px',
    ...
    <view id="xt__input-ground" class="xt__input-ground">
      <template v-for="(item, index) in size">
        <view
          ...
          :style="{
            borderColor:
              code.length === index && cursorVisible
                ? boxActiveColor
                : boxNormalColor,
          }"
        ...
        >
          <view
            ...
            class="xt__middle-line"
            v-if="type === 'middle' && !code[index]"
          ></view>
          <text class="xt__code-text">{{
            code[index] | codeFormat(isPassword)
          }}</text>
        </view>
      </template>
    </view>

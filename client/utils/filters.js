 ...
 * 跳转到登录页面
 */
export function navigateToLogin(type = "reLaunch") {
  /**
   * 此处进行条件编译判断
   * 微信小程序跳转到微信小程序登录页面
   * H5/App跳转到普通登录页面
...
export function serviceStatusList(val) {
  let statusList = {
    ...
    PASS: i18n.t("通过售后"),
    REFUSE: i18n.t("拒绝售后"),
    BUYER_RETURN: i18n.t("买家退货，待卖家收货"),
    SELLER_RE_DELIVERY: i18n.t("商家换货/补发"),
    SELLER_CONFIRM: i18n.t("卖家确认收货"),
    SELLER_TERMINATION: i18n.t("卖家终止售后"),
    BUYER_CONFIRM: i18n.t("买家确认收货"),
    BUYER_CANCEL: i18n.t("买家取消售后"),
    WAIT_REFUND: i18n.t("等待平台退款"),
    COMPLETE: i18n.t("完成售后"),
  };
...
export function orderStatusList(val) {
  let orderStatusList = {
    UNDELIVERED: i18n.t("待发货"),
    UNPAID: i18n.t("未付款"),
    PAID: i18n.t("已付款"),
    PARTS_DELIVERED: i18n.t("部分发货"),
    DELIVERED: i18n.t("已发货"),
    CANCELLED: i18n.t("已取消"),
    COMPLETED: i18n.t("已完成"),
    COMPLETE: i18n.t("已完成"),
    TAKE: i18n.t("待核验"),
    STAY_PICKED_UP: i18n.t("待自提"),
  };

const name = "necoshop"; //全局商城name
const schemeName = "necoshop"; //唤醒app需要的schemeName
export default {
  name: name,
  schemeLink: `${schemeName}://`, //唤起app地址
  downloadLink: "", //下载地址，下载app的地址
  shareLink: "https://m-b2b2c.novai.live", //分享地址，也就是在h5中默认的复制地址
  appid: "", //小程序唯一凭证，即 AppID，可在「微信公众平台 - 设置 - 开发设置」页中获得。（需要已经成为开发者，且帐号没有异常状态）
  aMapKey: "1f78544934b66c9fbc0104117f663973", //在高德中申请Web服务key
  scanAuthNavigation: ["https://m-b2b2c.novai.live/"], //扫码认证跳转域名配置 会根据此处配置的路由进行跳转
  iosAppId: "", //AppStore的应用地址id 具体在分享->拷贝链接中查看
  logo: "/icon.png", //logo地址
  customerServiceMobile: "11111111111", //客服电话
  customerServiceEmail: "aaaa@qq.com", //客服邮箱
  imWebSrc: "https://im.pickmall.cn", //IM地址
  baseWsUrl: "wss://im-api.novai.live/lili/webSocket", // IM WS 地址
  ...
  lightColor: "#07C160", // 高亮主题色
  aiderLightColor: "#07C160", // 辅助高亮颜色
  ...
  googleMapKey: "AIzaSyAPol7jZHzKb6-UqgIpyYhJ1nTH1-WFeXo", //谷歌地图key
};
